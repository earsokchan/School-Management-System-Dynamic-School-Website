          ...
          {features.map((feature, index) => {
            ...
            return (
              <Reveal key={feature.id} delay={index * 90}>
                <article className="group h-full rounded-xl border border-border bg-white p-7 shadow-card card-hover">
                  <span className="flex h-14 w-14 items-center justify-center rounded-xl bg-navy text-gold transition-colors duration-300 group-hover:bg-creeper group-hover:text-white">
